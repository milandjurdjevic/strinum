...
public class Generator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(provider, (productionContext, symbols) =>
        {
            ...
            foreach (var symbol in symbols.OfType<ITypeSymbol>())
            {
            ...
            writer.Indent--;
            writer.WriteLine('}');
            productionContext.AddSource("Strinum.Extensions.g.cs", writer.InnerWriter.ToString());
        });
    }
